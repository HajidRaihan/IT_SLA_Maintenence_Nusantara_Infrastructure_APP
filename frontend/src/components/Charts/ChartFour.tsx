    ...
    <div className="col-span-12 rounded-sm border border-stroke bg-white p-5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5">
      ...
      <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-4">
        <StatusItem
          color="#00008B"
          label="On Time"
          count={state.series[0]}
          total={sumStatus}
        />
        <StatusItem
          color="#ADD8E6"
          label="Late"
          count={state.series[1]}
          total={sumStatus}
        />
        <StatusItem
          color="#FF6347"
          label="Not Done"
          count={state.series[2]}
          total={sumStatus}
        />
        <StatusItem
          color="#B0B0B0"
