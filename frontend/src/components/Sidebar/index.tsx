          ...
          <nav className="mt-5 px-4 lg:px-6">
            ...
            <div>
              ...
              <ul className="mb-1 flex flex-col gap-1.5">
                ...
                <NavLink
                  to="/"
                  className={`text-xs group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <ul>
                <NavLink
                  to="/list-activity"
                  className={`text-xs group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('list-activity') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M464 32C490.5 32 512 53.49 512 80V432C512 458.5 490.5 480 464 480H48C21.49 480 0 458.5 0 432V80C0 53.49 21.49 32 48 32H464zM464 80H48V432H464V80zM192 208C209.7 208 224 193.7 224 176C224 158.3 209.7 144 192 144C174.3 144 160 158.3 160 176C160 193.7 174.3 208 192 208zM320 272C337.7 272 352 257.7 352 240C352 222.3 337.7 208 320 208C302.3 208 288 222.3 288 240C288 257.7 302.3 272 320 272zM432 336C449.7 336 464 321.7 464 304C464 286.3 449.7 272 432 272C414.3 272 400 286.3 400 304C400 321.7 414.3 336 432 336z" />
                  </svg>
                  List Activity
                </NavLink>
              </ul>
              ...
              <ul>
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/barang' || pathname.includes('barang')
                  }
                >
                  {(handleClick, open) => {
                    return (
                          ...
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <ul>
                              <NavLink
                                to="/listbarang"
                                className={({ isActive }) =>
                                  'text-xs group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                              >
                                List barang
              ...
              <ul>
                <li>
                  <NavLink
                    to="/grafik-kerja"
                    className={`text-xs group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('grafik-kerja') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              <li>
                <ul>
                  <h3 className="mb-1 ml-4 text-xs font-semibold text-bodydark2">
                    OTHERS
                  </h3>
                </ul>
              </li>
              ...
              {(handleClick, open) => {
                return (
                  <React.Fragment>
                    ...
                    >
                      <ul className="z-sm mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        {/* <li>
                              <NavLink
                                to="/auth/signin"
                                className={({ isActive }) =>
